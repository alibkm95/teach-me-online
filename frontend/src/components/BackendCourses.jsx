  ...
  return (
    <section className='w-full max-w-7xl mx-auto py-8 px-2 md:px-6'>
      ...
      <div className="bg-base-200 py-6 rounded-ee-xl rounded-es-xl px-2">
        {
          backendCourses.length === 0 && loading && <span className="loading loading-bars loading-lg block mx-auto"></span>
        }
        {
          backendCourses.length > 0 && <CreateSwiper courses={backendCourses} />
        }
        {
          backendCourses.length === 0 && !loading && (
